...
void Ejercicio(){
	...
	typename GrafoP<int>::vertice origen=1,destino=5;
...
void mejoropcion(const GrafoP<tCoste>& Bus,const GrafoP<tCoste>& Tren,const GrafoP<tCoste>& Avion,typename GrafoP<tCoste>::vertice origen,typename GrafoP<tCoste>::vertice destino,
	...
	vector<vertices> ruta1(Bus.numVert()+Tren.numVert()+Avion.numVert());
	vector<vertices> ruta2(Bus.numVert()+Tren.numVert()+Avion.numVert());
	vector<vertices> ruta3(Bus.numVert()+Tren.numVert()+Avion.numVert());
